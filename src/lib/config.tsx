...
export const siteConfig = {
  name: "React After",
  description: "A collection of powerful React libraries.",
  cta: "Documentation",
  url: process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3000",
  keywords: ["React", "Global State Management", "React Router", "Next"],
  links: {
  ...
  hero: {
    title: "React After",
    description:
      "Intuitive React libraries built on top of the technologies you know and love.",
    cta: "Documentation",
    ctaDescription: "Built for React",
  },
  features: [
    {
      name: "gState",
  ...
  footer: {
    ...
    bottomText: "ReactAfter 2025. All rights reserved.",
    brandText: "AFTER",
  },
